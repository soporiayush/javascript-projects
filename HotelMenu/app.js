...
//load all items
  ...
  //items to display item dyamically
  ...
  function displayMenuBtns(){
    //getting the unique values by reducing the array
    ...
    //dynamically setting the HTML for buttons
    const categoriesBtn = categories.map(function(item){
      return `<button class="filter-btn" type="button" data-id=${item}>
      ${item}
      </button>`
    }).join("");
        btnSection.innerHTML = categoriesBtn;
        ...
        filterBtns.forEach(function(btn){
          btn.addEventListener('click',function(e){
              ...
              //filtering the array based on the selecion
